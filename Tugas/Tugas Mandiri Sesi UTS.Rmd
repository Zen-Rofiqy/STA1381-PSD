...
Hal ini menunjukkan bahwa metode Stepwise Forward, dan Stepwise Backward menghasilkan kesimpulan yang sama yaitu: Model terbaik diperoleh dengan hanya memasukkan peubah `cyl`, `hp` , `wt`, `vs` , `am`.

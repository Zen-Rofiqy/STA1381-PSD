...
Untuk metode *non-hierarchical clustering* kami akan mencoba untuk membuat 3 culster. Kami berencana menggerombolkannya kedalam 3 kategori yakni :

1.  Tingkat Rawan Bencana **Tinggi**
2.  Tingkat Rawan Bencana **Sedang**
3.  Tingkat Rawan Bencana **Rendah**

Karena sebagaimana yang sudah dijelaskan di Pendahuluan, Indonesia merupakan daerah yang rawan bencana. Sehingga tidak mungkin kami akan mengkategorikan bencananya hanya 2. Karena jika demikian maka cluster yang terbentuk akan seperti ini : Rawan Bencana dan Tidak rawan Bencana. Yang mana ini bertentangan dengan "Indonesia Rawan Bencana". Sehingga kami juga secara tidak langsung akan meng-*highlight* bahwa daerah yang tingkat rawan bencana nya rendah itu cenderung sedikit di Indonesia.
...
![](http://127.0.0.1:33833/chunk_output/s/C3410F7C/cee9cwzctrffl/000019.png)
...
ggplot(centers_long, aes(x = cluster, y = value, fill = variable)) +
  ...
  ggtitle("Profil Klaster Rata-rata Intensitas 
          Terjadi Bencana Alam Menurut Provinsi di Indonesia")
```

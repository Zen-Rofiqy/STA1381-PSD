...
![](images/Screenshot 2023-09-18 072128.png){width="521"}
...
![](images/Screenshot 2023-09-18 073150-01.png){width="144"}
...
![](images/Screenshot 2023-09-18 080021.png)
...
![](images/Screenshot 2023-09-18 165425.png){width="734"}
...
3.  **Memberi Bobot pada setiap Benchmark\
    **`Chat GPT` memberi saran untuk nilai bobot masing-masing :\
    ![](images/Screenshot 2023-09-18 140457.png)\
...
5.  **Membagi nya dengan banyaknya Benchmark yang bukan 0 atau NA\
    ...
    `Score` : $\frac{A + B + C + D}{not.NA.nor.0}$
    `Score` : $\frac{0 + 0 + 1405 + 3329}{0+0+1+1}$\
    `Score` : $2367$\
...
![](images/Screenshot 2023-09-18 090033.png){width="257"}
...
![](images/Screenshot 2023-09-18 093917.png){width="240"}
...
![](images/Screenshot 2023-09-18 102128.png){width="527"}

Jika saya cari pada sheet CPU, terlihat bahwa tidak ada CPU NA yang ditemukan.

![](images/Screenshot 2023-09-18 103135.png)

...
```{r dpi=300, fig1, fig.height = 14, fig.width = 20, fig.align = "center", warning=FALSE}
...
```{r dpi=300, fig2, fig.height = 9, fig.width = 16, fig.align = "center", warning=FALSE}
...
```{r dpi=300, fig3, fig.height = 14, fig.width = 20, fig.align = "center", warning=FALSE}
# Membuat bar chart persentase
...
```{r dpi=300, fig4, fig.height = 20, fig.width = 23, fig.align = 'left', warning=FALSE}
...
```{r dpi=300, fig5, fig.height = 14, fig.width = 20, fig.align = "center", warning=FALSE}
# Membuat bar chart persentase
ggplot(data = storage %>%
...
```{r dpi=300, fig6, fig.height = 14, fig.width = 20, fig.align = "center", warning=FALSE}
# Membuat bar chart persentase
ggplot(data = storage %>%
...
![](images/Screenshot%202023-09-20%20053124.png)
...
Ini fungsi untuk cek yang 100% mirip. Segala kesalahan penulisan disamakan. Jika yang memang tidak sama maka tidak akan dipaksa sama. Misalnya ![](images/Screenshot%202023-09-19%20222107-01.png){width="330"}
...
![](images/Screenshot%202023-09-20%20053320-01.png){width="276"}
...
![](images/Screenshot%202023-09-19%20222107-01.png){width="468"}
...
![](images/Screenshot%202023-09-19%20224355.png){width="286"}
...
-   `Apple M2 (12-core CPU, 19-core GPU)` : [cpu-monkey.com](https://www.cpu-monkey.com/en/cpu-apple_m2_pro_12_cpu_19_gpu)

-   `Apple M2 (8-core GPU)` : [cpu-monkey.com](https://www.cpu-monkey.com/en/cpu-apple_m2_8_gpu)
...
![](images/Screenshot%202023-09-20%20040151.png){width="292"}

![](images/Screenshot%202023-09-20%20040419-01.png){width="296"}

![](images/Screenshot%202023-09-20%20040609.png){width="291"}

![](images/Screenshot%202023-09-20%20040709.png){width="293"}

![](images/Screenshot%202023-09-20%20040851.png){width="289"}

![](images/Screenshot%202023-09-20%20041000.png){width="288"}

![](images/Screenshot%202023-09-20%20041056.png){width="289"}

![](images/Screenshot%202023-09-20%20041307.png){width="280" height="37"}

Namun pada 7001:8000 ternyata ada missing data. Yakni ![](images/Screenshot%202023-09-20%20041201.png){width="204"}

Setelah kami cek di website ternyata memang tidak ada. Terpaksa kami harus cari datanya di internet.

-   `AMD Ryzen 5 3500C` : [cpu-monkey.com](https://www.cpu-monkey.com/en/cpu-amd_ryzen_5_3500c) & [versus.com](https://versus.com/en/amd-ryzen-5-3500c)

Lanjut pada 8001:9000 pun tidak ada yang NA ![](images/Screenshot%202023-09-20%20042426.png){width="306" height="38"}

![](images/Screenshot%202023-09-20%20043305.png){width="326"}

Ketika melewati itu maka akan ada error. Lalu kami perbaiki algoritma nya.

![](images/Screenshot%202023-09-20%20052603.png){width="329" height="42"}

Hasilnya tidak ada lagi error. Namun ternyata tersisa 1 `NA`. Yakni ![](images/Screenshot%202023-09-20%20052801.png){width="196"}
...
![](https://www.acerid.com/wp-content/uploads/2021/11/inner-2.jpg){width="538"}
...
```{r dpi=300, fig7, fig.height = 14, fig.width = 20, fig.align = "center", warning=FALSE}
# Membuat bar chart persentase
...
```{r dpi=300, fig8, fig.height = 9, fig.width = 16, fig.align = "center", warning=FALSE}
install_load('ggridges','hrbrthemes','viridis')
...
```{r dpi=300, fig9, fig.height = 9, fig.width = 16, fig.align = "center", warning=FALSE}
install_load('ggridges','hrbrthemes','viridis')
...
![](https://play3r.net/wp-content/uploads/2015/07/3DMark.jpg){width="548"}
...
![](images/Screenshot%202023-09-19%20211800.png){width="621"}
...
3.  **Memberi Bobot pada setiap Benchmark\
    **`Chat GPT` memberi saran untuk nilai bobot masing-masing :\
    ![](images/Screenshot%202023-09-20%20091849.png)\
    Dengan cara perkalian matriks antara data benchmark $(\mathbf{B})$ dengan matriks diagonal bobot $(\mathbf{D})$:
...
# Fungsi untuk mencari model GPU yang paling mirip
find_similar <- function(target, data) {
  
  #adist untuk menghitung jarak (distance) antara target_gpu dan setiap model GPU
  distances <- adist(target, data$Model, 
  #untuk memungkinkan pencocokan parsial (hanya sebagian dari string yang cocok)
                     partial = TRUE, 
  #ase-insensitive, sehingga tidak memedulikan huruf besar atau kecil.
...
![](https://www.cgdirector.com/wp-content/uploads/media/2021/11/Best-Graphics-Card-Brands-For-AMD-and-Nvidia-Twitter.jpg){width="644"}
...
```{r dpi=300, fig10, fig.height = 14, fig.width = 20, fig.align = "center", warning=FALSE}
# Membuat bar chart persentase
...
```{r dpi=300, fig11, fig.height = 9, fig.width = 16, fig.align = "center", warning=FALSE}
install_load('ggridges','hrbrthemes','viridis')
...
```{r dpi=300, fig12, fig.height = 9, fig.width = 16, fig.align = "center", warning=FALSE}
install_load('ggridges','hrbrthemes','viridis')
...
![](images/Screenshot%202023-09-20%20153804.png)
...
#Panggil fungsi
data <- join_and_score(data, cpu)
```

![](images/Screenshot%202023-09-20%20182351.png){width="349"}

![](images/Screenshot%202023-09-20%20182718.png){width="446"}

Ada 5 data yagn tidak sama. Ini berarti fungsi `join_and_score1` & `join_and_score2` belum $100\%$ Tepat.

![](images/Screenshot%202023-09-20%20192425-01.png){width="620"}

Saya salah, malahan ternyata yang belum tepat itu fungsi `join_and_score`. Ini bisa dilihat pada :

![](images/Screenshot%202023-09-20%20191610.png){width="355"}

![](images/Screenshot%202023-09-20%20191725.png){width="339"}

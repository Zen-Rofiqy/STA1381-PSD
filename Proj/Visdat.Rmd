...
ggplot(data = data, aes(x = `Storage Score`, y = `Price (IDR)`/1000, color = `Storage Type`)) +
  ...
  scale_color_manual(values = c("SSD" = "#3788A1", "HDD" = "#504E58")) +
  theme3.2 +
...
chart
#Export Chart
ggsave("04.2_Bar Chart Resolution Laptop_Urut.png", chart, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
chart
#Export Chart
ggsave("04.3_Bar Chart Screen Type Laptop.png", chart, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
chart 
#Export Chart
ggsave("04.4_Bar Chart Screen Type Laptop_Horizontal.png", chart, path = export.chart,
        dpi = 300, height = 20, width = 14)
```
...
chart
#Export Chart
ggsave("04.4_Bar Chart Refresh Rate (Hz) Laptop_Urut.png", chart, path = export.chart,
        dpi = 300, height = 14, width = 20)
```

...
bar.brand_laptop 
#Export Chart
ggsave("01.1_Sebaran Brand Laptop.png", bar.brand_laptop, path = export.chart,
...
bar.brand_laptop.h 
#Export Chart
ggsave("01.2_Sebaran Brand Laptop.png", bar.brand_laptop.h, path = export.chart,
...
ggplot(data, aes(x=`Price (IDR)`/1000, 
  ...
  geom_violin(scale="count", fill='#fdbe4a', color='black', alpha=0.9, 
                    trim = FALSE) +
  #Boxplot
  geom_boxplot(fill='#9d5692', color='black',
                     outlier.size=2, outlier.color='#9d5692', 
                     notch=T, width=0.2) +
  #Mean Marker
...
harga
#Export Chart
ggsave("02.1_Sebaran Harga Laptop.png", harga, path = export.chart,
...
ggplot(data, aes(x=`Price (IDR)`/1000, y=Brand, fill=Brand)) + 
  ...
  scale_fill_viridis(alpha = 0.75, #Opacity
                     begin = 0.25, #Color pallte scale begins
...
harga.brand
#Export Chart
ggsave("02.2_Sebaran Harga Laptop .png", harga.brand, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
ggplot(gg.data, aes(x = "", y = count, fill = `Storage Type`)) +
  ...
  coord_polar(theta = "y") +
  scale_fill_manual(values =c(SSD = "#1380A1", HDD = "#dddddd")) +
  theme_void() +
  labs(title = "\nProporsi SSD dan HDD") + theme3
pie 

#Export Chart
ggsave("03.1_Proporsi SSD dan HDD.png", pie, path = export.chart,
...
ggplot(data = gg.data,
  ...
  geom_bar(stat = "identity", col=NA,
           fill = ifelse(gg.data$top3,  c("#1380A1", "#178CA8", "#189DB2"),
                         "#dddddd")
           ) + 
...
bar.ssd 
#Export Chart
ggsave("03.2_Sebaran SSD Laptop.png", bar.ssd, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
bar.ssd.h 
#Export Chart
ggsave("03.3_Sebaran SSD Laptop.png", bar.ssd.h, path = export.chart,
...
bar.ssd.urut
#Export Chart
ggsave("03.4_Sebaran SSD Laptop_Urut.png", bar.ssd.urut, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
bar.ssd.urut.h 
#Export Chart
ggsave("03.5_Sebaran SSD Laptop_Urut.png", bar.ssd.urut.h, path = export.chart,
        dpi = 300, height = 20, width = 14)
```
...
ggplot(data = gg.data,
       aes(x = reorder(`Storage (GB)`, `Storage (GB)`), y = perc)) +
  geom_bar(stat = "identity", col=NA,
           fill = ifelse(gg.data$top1,  c("#1380A1"),
                         "#dddddd")
           ) + 
...
bar.hdd 
#Export Chart
ggsave("03.6_Sebaran HDD Laptop.png", bar.hdd, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
bar.hdd.h 
#Export Chart
ggsave("03.7_Sebaran HDD Laptop.png", bar.hdd.h, path = export.chart,
        dpi = 300, height = 20, width = 14)
```
...
bar.hdd.urut
#Export Chart
ggsave("03.8_Sebaran HDD Laptop_Urut.png", bar.hdd.urut, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
bar.hdd.urut.h 
#Export Chart
ggsave("03.9_Sebaran HDD Laptop_Urut.png", bar.hdd.urut.h, path = export.chart,
        dpi = 300, height = 20, width = 14)
```
...
ss
#Export Chart
ggsave("03.10_Sebaran Storage Score.png", ss, path = export.chart,
        dpi = 300, height = 10, width = 20)
```
...
ss.t
#Export Chart
ggsave("03.11_Sebaran Storage Score Per Tipe.png", ss.t, path = export.chart,
        dpi = 300, height = 10, width = 20)
```
...
ss.brand
#Export Chart
ggsave("03.12_Sebaran Storage Score Laptop .png", 
       ss.brand, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
ggplot(data = data, aes(x = `Storage Score`, y = `Price (IDR)`/1000, color = `Storage Type`)) +
  ...
  scale_color_manual(values = c("SSD" = "#1380A1", "HDD" = "orange")) +
  theme3.2 +
...
scat.ss
#Export Chart
ggsave("03.13_Scatteplot Storage Score degan Price.png", 
       scat.ss, path = export.chart,
        dpi = 300, height = 10, width = 20)
```
...
screen_size
#Export Chart
ggsave("04.1_Bar Chart Screen Size Laptop_Urut.png", screen_size, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
res
#Export Chart
ggsave("04.2_Bar Chart Resolution Laptop_Urut.png", res, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
s.type
#Export Chart
ggsave("04.3_Bar Chart Screen Type Laptop_Urut.png", s.type, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
rr
#Export Chart
ggsave("04.4_Bar Chart Refresh Rate (Hz) Laptop_Urut.png", rr, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
d.score
#Export Chart
ggsave("04.5_Sebaran Display Score Laptop.png", d.score, path = export.chart,
        dpi = 300, height = 10, width = 20)
```
...
d.score.brand
#Export Chart
ggsave("04.5_Sebaran Display Score Laptop .png", 
       d.score.brand, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
ggplot(data = data, aes(x = `Display Score`, y = `Price (IDR)`/1000)) +
  geom_point(alpha = 0.5, size = 7, col="#1380A1") +
  geom_smooth(method = "lm", formula = y ~ x, se = FALSE, size = 0.5) +
...
ram
#Export Chart
ggsave("05.1_Bar Chart Ram (GB) Laptop_Urut.png", ram, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
scat.ds
#Export Chart
ggsave("05.2_Scatteplot RAM (GB) degan Price.png", 
       scat.ds, path = export.chart,
        dpi = 300, height = 10, width = 20)
```
...
cpu_brand
#Export Chart
ggsave("06.1_Bar Chart CPU Brand Laptop_Urut.png", cpu_brand, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
cpu.score
#Export Chart
ggsave("06.2_Sebaran CPU Score Laptop.png", cpu.score, path = export.chart,
        dpi = 300, height = 10, width = 20)
```
...
cpu_score.cpu_brand
#Export Chart
ggsave("06.3_Sebaran CPU Score Per CPU Brand.png", cpu_score.cpu_brand, path = export.chart,
        dpi = 300, height = 10, width = 20)
```
...
ggsave("06.4_Sebaran CPU Score per Brand Laptop .png", 
       cpu.score.brand, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
...
gpu.score
#Export Chart
ggsave("07.2_Sebaran GPU Score Laptop.png", gpu.score, path = export.chart,
        dpi = 300, height = 10, width = 20)
```
...
gpu_scoure.gpu_brand
#Export Chart
ggsave("07.3_Sebaran GPU Score Per GPU Brand.png", gpu_scoure.gpu_brand, path = export.chart,
        dpi = 300, height = 10, width = 20)
```
...
gpu.score.brand
#Export Chart
ggsave("07.4_Sebaran GPU Score per Brand Laptop .png", 
       gpu.score.brand, path = export.chart,
        dpi = 300, height = 14, width = 20)
```
